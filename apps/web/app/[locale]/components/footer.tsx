  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-16">
        {/* Current CEST Time */}
        <div className="mb-8">
          <div className="inline-flex items-center gap-2 px-2 py-1 border border-gray-700 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className={`space-y-2 transition-all duration-200 ${openSections.navigation ? 'block' : 'hidden lg:block'}`}>
              ...
              <li>
                <Link href="/models/application" className="text-gray-400 hover:text-white transition-colors">
                  Apply
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <div className="mt-6 flex flex-col md:flex-row gap-4">
            <div className="text-xs text-gray-500">
              <div className="font-medium text-gray-400 mb-1">Italy</div>
              <div>Via Felice Bellotti, 12</div>
              <div>0129 Milano MI</div>
            </div>
            <div className="text-xs text-gray-500">
              <div className="font-medium text-gray-400 mb-1">United Kingdom</div>
              <div>128 City Rd</div>
