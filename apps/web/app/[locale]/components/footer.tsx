        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <button 
              ...
              className="flex items-center justify-between w-full text-black font-semibold mb-4 lg:mb-4"
            >
            ...
            <ul className={`space-y-2 transition-all duration-200 ${openSections.navigation ? 'block' : 'hidden lg:block'}`}>
              ...
              <li>
                <Link href="/chi-siamo" className="text-gray-600 hover:text-black transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/models/application" className="text-gray-600 hover:text-black transition-colors">
                  Apply
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-200 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center">
            ...
            <div className="flex items-center gap-2 mb-2">
              <p className="whitespace-nowrap font-normal text-lg text-black" style={{ fontFamily: 'Raleway, sans-serif' }}>
                Velgance Agency
              </p>
            </div>
            </div>
            ...
            <div className="text-xs text-gray-400">
              Copyright © 2025, Velgance Agency. All Rights Reserved.
            </div>
          </div>
          ...
          <div className="mt-6 flex flex-col md:flex-row gap-4">
            <div className="text-xs text-gray-500">
              <div className="font-medium text-gray-700 mb-1">Italy</div>
              <div>Via Felice Bellotti, 12</div>
              <div>0129 Milano MI</div>
            </div>
            <div className="text-xs text-gray-500">
              <div className="font-medium text-gray-700 mb-1">United Kingdom</div>
              <div>128 City Rd</div>
